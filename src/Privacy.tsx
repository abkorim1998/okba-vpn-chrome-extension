    ...
    return (
        <div className="container">
            <div className="header">
                <div className="logo">
                    <img src="asset/active.png" alt="vpn proxy" />
                    <h1>vpn proxy</h1>
                </div>
                <div className="manu">
                    <ul>
                        <li><a href="options.html">settings</a></li>
                        <li><a href="privacy.html" className="active">Privacy policy</a></li>
            ...
            <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
                ...
                created with the help of the <a rel="noopener" href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank">TermsFeed Privacy Policy Generator</a>.</p>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Application</strong> means the software program provided by the Company downloaded by You on
                        any electronic device, named vpo</p>
                </li>
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to vpo.</p>
                </li>
                <li>
            ...
            <ul>
                <li>
                    <p>By email: abkorim1998@gmail.com</p>
                </li>
                <li>
                    <p>By visiting this page on our website: <a href="https://abkorim.com" rel="external nofollow noopener"
                        target="_blank">https://abkorim.com</a></p>
                </li>
                <li>
                    <p>By phone number: +8801961696255</p>
                </li>
            </ul>
